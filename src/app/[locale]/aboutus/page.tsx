...
import { InfoCard } from "../components/VnM";
    ...
    <SuspenseWrapper>
      <main>
        <HeroHeader
          ...
          heading={{
            main: t("aboutUs.intro.title"),
          }}
          subheading={t("aboutUs.intro.description")}
          laptopImage="/labels/Final_Tablet.png"
        />

        <section className="mb-7 flex w-full items-center justify-center bg-gradient-to-b from-black to-[#1a1500] px-4 py-8 text-white">
