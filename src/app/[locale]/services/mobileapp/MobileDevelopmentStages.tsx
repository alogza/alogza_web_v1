...
export default function MobileAppDevelopmentProcess() {
  ...
  const stages: Stage[] = [
    {
      title: t("servicesPage.mobileApp.process.steps.planning.title"),
      description: t("servicesPage.mobileApp.process.steps.planning.desc"),
      icon: ClipboardList,
      image: "/assets/bg.png",
    },
    {
      title: t("servicesPage.mobileApp.process.steps.design.title"),
      description: t("servicesPage.mobileApp.process.steps.design.desc"),
      icon: PenTool,
      image: "/assets/bg.png",
    },
    {
      title: t("servicesPage.mobileApp.process.steps.development.title"),
      description: t("servicesPage.mobileApp.process.steps.development.desc"),
      icon: Code,
      image: "/assets/bg.png",
    },
    {
      title: t("servicesPage.mobileApp.process.steps.testing.title"),
      description: t("servicesPage.mobileApp.process.steps.testing.desc"),
      icon: Bug,
      image: "/assets/bg.png",
    },
    {
      title: t("servicesPage.mobileApp.process.steps.deployment.title"),
      description: t("servicesPage.mobileApp.process.steps.deployment.desc"),
      icon: Rocket,
      image: "/assets/bg.png",
    },
  ];
  ...
  return (
    <div className="flex min-h-screen w-full items-center justify-center bg-black px-4 py-10 text-white sm:px-6 md:py-16">
      <div className="mx-auto w-full max-w-7xl">
        ...
        >
          {t("servicesPage.mobileApp.process.title")}
        </motion.h1>
