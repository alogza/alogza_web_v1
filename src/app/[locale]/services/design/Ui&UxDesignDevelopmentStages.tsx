...
export default function Ui_UxDesignDevelopmentProcess() {
  ...
  const stages: Stage[] = [
    {
      title: t("servicesPage.uiuxDesign.process.steps.research.title"),
      description: t("servicesPage.uiuxDesign.process.steps.research.desc"),
      icon: SearchCheck,
      image: "/assets/bg.png",
    },
    {
      title: t("servicesPage.uiuxDesign.process.steps.journey.title"),
      description: t("servicesPage.uiuxDesign.process.steps.journey.desc"),
      icon: Route,
      image: "/assets/bg.png",
    },
    {
      title: t("servicesPage.uiuxDesign.process.steps.prototyping.title"),
      description: t("servicesPage.uiuxDesign.process.steps.prototyping.desc"),
      icon: LayoutDashboard,
      image: "/assets/bg.png",
    },
    {
      title: t("servicesPage.uiuxDesign.process.steps.visual.title"),
      description: t("servicesPage.uiuxDesign.process.steps.visual.desc"),
      icon: Palette,
      image: "/assets/bg.png",
    },
    {
      title: t("servicesPage.uiuxDesign.process.steps.testing.title"),
      description: t("servicesPage.uiuxDesign.process.steps.testing.desc"),
      icon: RefreshCcw,
      image: "/assets/bg.png",
    },
  ];
  ...
  return (
    <div className="flex min-h-screen w-full items-center justify-center bg-black px-4 py-10 text-white sm:px-6 md:py-16">
      <div className="mx-auto w-full max-w-7xl">
        ...
        >
          {t("servicesPage.uiuxDesign.process.title")}
        </motion.h1>
