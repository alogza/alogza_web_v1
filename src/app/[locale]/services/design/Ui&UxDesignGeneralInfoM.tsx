...
export default function Ui_UxDesignStaircaseConcept() {
      ...
      <div className="flex flex-col-reverse items-center justify-between gap-8 md:flex-row">
        ...
        <div className="w-full px-4 md:w-1/2 md:px-8">
          <h2 className="mb-4 text-2xl font-bold md:text-3xl lg:text-4xl w-[80%]">
            {t("servicesPage.uiuxDesign.smartSolutions.title")}
          </h2>
          <p className="text-base text-justify md:text-base w-[80%]">
            {t("servicesPage.uiuxDesign.smartSolutions.content")}
          </p>
        </div>
      </div>
    </div>
