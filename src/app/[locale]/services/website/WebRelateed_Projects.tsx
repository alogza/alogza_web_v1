...
export default function WebRelatedProjectsStandalone() {
  ...
  const projects: Project[] = [
    {
      ...
      description: t("projectsPage.projects.isianpadu.description"),
    ...
    },
    {
      ...
      description: t("projectsPage.projects.aichatbot.description"),
    ...
    },
    {
      ...
      description: t("projectsPage.projects.sfaweb.description"),
    ...
    },
    {
      ...
      description: t("projectsPage.projects.certificate.description"),
              ...
              {project.featured ? (
                ...
                <div className="flex h-full flex-col">
                  ...
                  <div className="flex flex-1 flex-col justify-between p-4">
                    ...
                    <LinkWithLoading
                      href={project.url}
                      className="mt-4 w-full rounded-xl bg-white py-2 text-center text-sm font-medium text-black transition-all hover:scale-105 hover:bg-gray-200"
                    >
                      {t("home.projects.items.readMore")}
                    </LinkWithLoading>
                  </div>
