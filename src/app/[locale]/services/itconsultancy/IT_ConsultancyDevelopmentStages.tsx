...
import { ClipboardList, Code, Bug, Repeat2, Lightbulb } from "lucide-react";
...
export default function IT_ConsultancyDevelopmentProcess() {
  ...
  const stages: Stage[] = [
    {
      title: t("servicesPage.itConsultancy.process.steps.consultation.title"),
      description: t(
        "servicesPage.itConsultancy.process.steps.consultation.desc"
      ),
      icon: Lightbulb,
      image: "/assets/bg.png",
    },
    {
      title: t("servicesPage.itConsultancy.process.steps.strategy.title"),
      description: t("servicesPage.itConsultancy.process.steps.strategy.desc"),
      icon: ClipboardList,
      image: "/assets/bg.png",
    },
    {
      title: t("servicesPage.itConsultancy.process.steps.design.title"),
      description: t("servicesPage.itConsultancy.process.steps.design.desc"),
      icon: Code,
      image: "/assets/bg.png",
    },
    {
      title: t("servicesPage.itConsultancy.process.steps.implementation.title"),
      description: t(
        "servicesPage.itConsultancy.process.steps.implementation.desc"
      ),
      icon: Bug,
      image: "/assets/bg.png",
    },
    {
      title: t("servicesPage.itConsultancy.process.steps.support.title"),
      description: t("servicesPage.itConsultancy.process.steps.support.desc"),
      icon: Repeat2,
      image: "/assets/bg.png",
    },
  ];
  ...
  return (
    <div className="flex min-h-screen w-full items-center justify-center bg-black px-4 py-10 text-white sm:px-6 md:py-16">
      <div className="mx-auto w-full max-w-7xl">
        ...
        >
          {t("servicesPage.itConsultancy.process.title")}{" "}
        </motion.h1>
