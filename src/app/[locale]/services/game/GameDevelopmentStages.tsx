...
import { PenTool, Code, Bug, Rocket, Lightbulb } from "lucide-react";
...
export default function GameDevelopmentProcess() {
  ...
  const stages: Stage[] = [
    {
      title: t("servicesPage.gameDevelopment.process.steps.concept.title"),
      description: t("servicesPage.gameDevelopment.process.steps.concept.desc"),
      icon: Lightbulb,
      image: "/assets/bg.png",
    },
    {
      title: t("servicesPage.gameDevelopment.process.steps.design.title"),
      description: t("servicesPage.gameDevelopment.process.steps.design.desc"),
      icon: PenTool,
      image: "/assets/bg.png",
    },
    {
      title: t("servicesPage.gameDevelopment.process.steps.production.title"),
      description: t(
        "servicesPage.gameDevelopment.process.steps.production.desc"
      ),
      icon: Code,
      image: "/assets/bg.png",
    },
    {
      title: t("servicesPage.gameDevelopment.process.steps.testing.title"),
      description: t("servicesPage.gameDevelopment.process.steps.testing.desc"),
      icon: Bug,
      image: "/assets/bg.png",
    },
    {
      title: t("servicesPage.gameDevelopment.process.steps.launch.title"),
      description: t("servicesPage.gameDevelopment.process.steps.launch.desc"),
      icon: Rocket,
      image: "/assets/bg.png",
    },
  ];
  ...
  return (
    <div className="flex min-h-screen w-full items-center justify-center bg-black px-4 py-10 text-white sm:px-6 md:py-16">
      <div className="mx-auto w-full max-w-7xl">
        ...
        >
          {t("servicesPage.gameDevelopment.process.title")}
        </motion.h1>
